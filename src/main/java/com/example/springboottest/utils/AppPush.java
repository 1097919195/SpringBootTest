...
public class AppPush {
    public static void push() {
        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAIWDPtbzay8rfp", "ZhpRZamLGFHkA3AAuF4s9LBbpaeJgc");
        DefaultAcsClient client = new DefaultAcsClient(profile);
        PushRequest pushRequest = new PushRequest();
        // 推送目标
        pushRequest.setAppKey(Long.valueOf(25084781));
